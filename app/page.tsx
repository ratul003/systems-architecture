    ...
    <main className="min-h-screen text-[#e2e8f0]" style={{ backgroundColor: "#0a0a0f" }}>
      ...
      >
        <div className="flex items-center gap-3 md:gap-4 min-w-0">
          <span className="text-sm font-semibold tracking-widest uppercase text-[#f43f5e] whitespace-nowrap">Systems Architecture</span>
        ...
        <span className="hidden min-[420px]:inline sm:hidden text-xs text-[#94a3b8] whitespace-nowrap">Wahid T. Ratul</span>
      </nav>
